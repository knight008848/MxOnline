    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', models.CharField(max_length=200, verbose_name='详情')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_company', models.CharField(max_length=50, verbose_name='工作地点')),
                ('work_position', models.CharField(max_length=50, verbose_name='职位')),
                ('points', models.CharField(max_length=50, verbose_name='教学特点')),
                ('fav_nums', models.IntegerField(default=0, verbose_name='收藏数')),
                ('click_nums', models.IntegerField(default=0, verbose_name='点击数')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('org', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organization.CourseOrg', verbose_name='机构')),
            ],
            options={
                'verbose_name': '讲师',
